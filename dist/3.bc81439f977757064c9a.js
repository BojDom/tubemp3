...
// module
exports.push([module.i, "#search[data-v-69619444]{overflow-y:auto}", ""]);
...
exports.default = {
	...
	sockets: {
		pageToken: function pageToken(tok) {
			this.pageToken = tok;
		},
		add: function add() {
	...
	mounted: function mounted() {
		...
		this.$store.commit('addThumbnail', false);
		new _rxLite.Observable.create(function (sub) {
			if (_this.isConnected) sub.next();else _this.$watch("isConnected", function () {
				if (_this.isConnected) sub.next();
			});
		}).take(1).subscribe(function (ok) {
			_this.search();
		});
	}
};
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(426)("4170d3c1", content, true, {});
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }), 1) : _c('div', [_c('loading')], 1), (_vm.thumbnails.length > 8) ? _c('vue-inf', {
    staticStyle: {
      "width": "100%"
    },
    attrs: {
