export default {
	"homeTitle": {
		it: "Converti e scarica gratis musica in mp3 da youtube.",
		en: "Download free mp3 from youtube converted in high quality."
	},
	"homeDescription": {
		it: "Non serve registrarsi ed é piú semplice di quanto tu possa credere, scaricare musica non é mai stato cosi facile :)",
		en: "No registration needed, download music form youtube had never ben so easy :)"
	},
	"hi": {
		it: "ciao",
		en: "hello"
